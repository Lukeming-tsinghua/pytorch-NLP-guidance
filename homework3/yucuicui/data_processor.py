...
def tokenizer(text): 
    ...
    Jword=[word for word in jieba.cut(text)]    
...
def get_stop_words():
    ...
    for line in file_object.readlines():
      ...
      sTW=line.decode('utf-8')
      stop_words.append(sTW)
    return stop_words
...
def load_data(args):
    ...
    if args.static:
        ...
        text.build_vocab(train, val, vectors=Vectors(name="data/word_embedding.txt"))
